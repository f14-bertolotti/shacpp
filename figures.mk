# To use this makefile you need to have jet (commit 70c4972) installed, see:
...
data/transport-$1-$2.pdf: 
	...
	jet line --color ${SHACRM_COLOR} --input-path data/shacrm/transport/$1/$2/42/eval.log --x message/episode --y message/reward --label shacrm \
	jet line --color ${SHACRM_COLOR} --input-path data/shacrm/transport/$1/$2/43/eval.log --x message/episode --y message/reward --label shacrm \
	jet line --color ${SHACRM_COLOR} --input-path data/shacrm/transport/$1/$2/44/eval.log --x message/episode --y message/reward --label shacrm \
	...
	jet line \
		--input-path data/ppo/transport/$1/$2/42/eval.log \
		--input-path data/ppo/transport/$1/$2/43/eval.log \
		--input-path data/ppo/transport/$1/$2/44/eval.log \
		--input-path data/shac/transport/$1/$2/42/eval.log \
		--input-path data/shac/transport/$1/$2/43/eval.log \
		--input-path data/shac/transport/$1/$2/44/eval.log \
		--input-path data/shacrm/transport/$1/$2/42/eval.log \
		--input-path data/shacrm/transport/$1/$2/43/eval.log \
		--input-path data/shacrm/transport/$1/$2/44/eval.log \
		--input-path data/shacwm/transport/$1/$2/42/eval.log \
		--input-path data/shacwm/transport/$1/$2/43/eval.log \
		--input-path data/shacwm/transport/$1/$2/44/eval.log \
		--x message/episode \
		--y message/max_reward \
		--linestyle dashed \
		--color 0 0 0 \
		--label max \
	jet legend \
		...
		--line shacrm ${SHACRM_COLOR} 1 \
		--line shacwm ${SHACWM_COLOR} 1 \
	jet mod \
		--right-spine False \
		--top-spine False \
		--x-label "episode" \
...
data/dispersion-$1-$2.pdf: 
	...
	jet line \
		--input-path data/ppo/dispersion/$1/$2/42/eval.log \
		--input-path data/ppo/dispersion/$1/$2/43/eval.log \
		--input-path data/ppo/dispersion/$1/$2/44/eval.log \
		--input-path data/shacwm/dispersion/$1/$2/42/eval.log \
		--input-path data/shacwm/dispersion/$1/$2/43/eval.log \
		--input-path data/shacwm/dispersion/$1/$2/44/eval.log \
		--x message/episode \
		--y message/max_reward \
		--linestyle dashed \
		--color 0 0 0 \
...
figures: transport-fig dispersion-fig
