...
\begin{tikzpicture}
    ...
    \foreach \i in {0, ..., \nodes} {
        ...
        \draw[-,line width=1,color=DarkOrchid] (a\i) -- (R\i);
        \draw[-,line width=1,color=DarkOrchid] (sa\i) -- ($(sa\i) + (.6,0)$) to[out=0,in=270]   ($(R\i) - (0,.2)$) -- (R\i);
        \draw[-,line width=1,color=DarkOrchid] (sa\j) -- ($(sa\j) - (.6,0)$) to[out=180,in=270] ($(R\i) - (0,.2)$) -- (R\i);
    }
    ...
    \foreach \i in {0, ..., \nodes} {
        ...
        \draw[-latex,line width=1, color=orange, dashed] (a\i) -- ($(a\i) + (0,1.1)$) to[out=90,in=180] ($(s\j) - (.9,0)$) -- (s\j);
