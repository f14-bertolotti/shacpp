\begin{figure*}[t]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        ...
        \label{fig:shacpp}
    \end{subfigure}
    \caption{Comparison between SHAC and \fname{}. Nodes with labels (such as $r_i$ or $r'_i$) values. Nodes without labels (such as $\pi$ or $R$) represent functions. Dashed lines are used to represent non differentiability. $a_i$ and $r_i$ represent the collection of actions and rewards for all agents}\label{fig:shac-shacpp}
\end{figure*}
