...
For more details about the choice of environments, see \Cref{apx:scenarios} in appendix~\cite{appendix}.
We selected four distinct scenarios: Dispersion, Discovery, Transport, and Sampling, specifically for their cooperative nature and varying levels of required coordination (see \Cref{fig:scenarios} and \Cref{apx:scenarios} in appendix~\cite{appendix} for details). These scenarios can be categorized along two dimensions:
\begin{compactitem}
