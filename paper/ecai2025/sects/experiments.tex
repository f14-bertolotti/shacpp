...
In this section, we test \fname{} with PPO and SHAC for a set of multi-agent scenarios and architectures. An ablation study when replacing only the transition function (SHAC+,meaning that the reward function is assumed differentiable) is also conducted in \Cref{apx:ablation}.
